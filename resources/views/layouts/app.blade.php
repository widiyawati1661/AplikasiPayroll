...
<html lang="en">
  <head>
    ...
    <!-- ASSET SUDAH MEMBACA DIREKTORI PUBLIC -->
...
<meta name="theme-color" content="#7952b3">
    ...
    <!-- ASSET DIMANA SIMPAN CSS NAVBAR -->
    <link href="{{asset('pertama/css/navbar-top-fixed.css')}}" rel="stylesheet">
  </head>
  <body>
...
<main class="container">
  <div class="bg-light p-3 d-flex justify-content-between align-items-center">
    ...
    <h5>APLIKASI PAYROLL</h5>
    <p class="d-flex justify-content-between align-items-center">&copy; 18111280_Widiyawati_TIFK18CID</p>
